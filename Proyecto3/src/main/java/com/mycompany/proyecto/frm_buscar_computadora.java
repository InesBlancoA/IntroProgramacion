 ...
 * @author Melissa
 */
public class frm_buscar_computadora extends javax.swing.JFrame {

    /**
     * Creates new form frm_buscar_computadora
     */
    DefaultTableModel tabla;
    Vector VectCabe = new Vector();
    
    public frm_buscar_computadora() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Digite el código del producto que deseas buscar");
        ...
        jLabel1.setText("Aquí se muestra la información del producto que buscaste");
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        ...
        tabla_buscar.setModel(computadoras.buscar_por_codigo_producto(buscar_codigo));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_buscar_computadora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_buscar_computadora().setVisible(true);
            }
        });
    }
