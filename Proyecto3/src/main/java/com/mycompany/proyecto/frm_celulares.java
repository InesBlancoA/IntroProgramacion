 ...
 * @author danie
 */
public class frm_celulares extends javax.swing.JFrame {

    /**
     * Creates new form frm_celulares
     */
    public frm_celulares() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txt_funcionalidades = new javax.swing.JTextArea();
        ...
        lbl_info.setText("REGISTRO DE CELULARES");
        ...
        lbl_tipo.setText("Modelo");

        lbl_descripcion.setFont(new java.awt.Font("Bahnschrift", 0, 14)); // NOI18N
        lbl_descripcion.setText("Funcionalidades");

        txt_funcionalidades.setColumns(20);
        txt_funcionalidades.setRows(5);
        jScrollPane2.setViewportView(txt_funcionalidades);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(lbl_tipo, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(txt_modelo, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        ...
        String modelo_pr = txt_modelo.getText();
        String funcionalidades_pr = txt_funcionalidades.getText();
        ...
        Celulares obj_celulares = new Celulares(modelo_pr, funcionalidades_pr);

        Celulares obj_celu = new Celulares();

        obj_celu.setObj_producto_celulares(obj_pr);
        obj_celu.setFuncionalidades(funcionalidades_pr);
        obj_celu.setModelo(modelo_pr);
        obj_celu.agregar_producto();
    ...
    private void limpia_cajas_de_texto (){
        ...
        this.txt_funcionalidades.setText("");
        
    }
    
    private void llamar_formulario (){
        frm_menu_celulares menu = new frm_menu_celulares();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_celulares.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_celulares().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea txt_funcionalidades;
